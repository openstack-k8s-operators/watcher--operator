...
func (r *WatcherDecisionEngineReconciler) createDeployment(
	ctx context.Context,
	h *helper.Helper,
	instance *watcherv1beta1.WatcherDecisionEngine,
	inputHash string,
	...
	ss := statefulset.NewStatefulSet(watcherdecisionengine.StatefulSet(instance, inputHash, getDecisionEngineServiceLabels()), r.RequeueTimeout)
